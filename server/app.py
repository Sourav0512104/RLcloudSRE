...
"""
FastAPI application for the Cloud Sre Rl Environment.

This module creates an HTTP server that exposes the CloudSreRlEnvironment
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    This function enables running the server without Docker:
        ...
        python -m cloud_sre_rl.server.app
    ...
    multiple workers:
        uvicorn cloud_sre_rl.server.app:app --workers 4
    """
    import uvicorn
